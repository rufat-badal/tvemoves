...
from .helpers import random_symbolic_polynomial_2d, random_symbolic_polynomial_1d
...
def test_dunavant() -> None:
    ...
    for i, rule in enumerate(DUNAVANT_QUADRATURE_RULES):
        ...
        degree = i + 1
        poly_symbolic = random_symbolic_polynomial_2d(degree, x, y)
...
def test_gauss() -> None:
    ...
    for degree in range(1, 6):
        ...
        poly_symbolic = random_symbolic_polynomial_1d(degree, x)
